...
# fonts installations...
pacman -S powerline-fonts ttf-font-awesome ttf-nerd-fonts-symbols ttf-inconsolata --needed --noconfirm
...
pacman -S alacritty neovim mc htop git ranger fzf manjaro-zsh-config zsh zsh-autosuggestions zsh-completions zsh-history-substring-search zsh-syntax-highlighting --needed --noconfirm
# game installations...
